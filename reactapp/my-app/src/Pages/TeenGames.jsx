...
const TeenGames = () => {
  ...
  return (
    <div className="flex min-h-screen bg-[#EEEEE]">
      {/* Sidebar */}
      <TeenSidebar />

      {/* Main Content */}
      <div className="flex-1 flex items-center justify-center p-6">
        <div className="max-w-md w-full rounded-2xl shadow-2xl overflow-hidden border border-[#9B7EBD] bg-[#3B1E54]">
          ...
          <div className="p-5 text-center relative">
            ...
            <h1 className="text-2xl font-bold text-white">Tongue Twister Challenge</h1>
            <p className="text-sm opacity-90 mt-1 text-[#D4BEE4]">
              Test your articulation skills
            </p>
