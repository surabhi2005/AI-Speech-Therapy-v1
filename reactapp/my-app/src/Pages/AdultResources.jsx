...
import AdultSidebar from "./AdultSidebar"; // <-- Added import

const mockResources = [
  {
    id: 1,
    title: "Complex Sentences",
    content: "https://www.youtube.com/embed/CsrM_RpqXek",
    type: "video",
    category: "Speech Therapy",
    duration: "5 min",
    thumbnail: "https://img.youtube.com/vi/CsrM_RpqXek/hqdefault.jpg"
  },
  {
    id: 2,
    title: "Make A Sentence Quickly",
    content: "https://www.youtube.com/embed/fyVBYA0CKr0",
    type: "video",
    category: "Speech Therapy",
    duration: "8 min",
    thumbnail: "https://img.youtube.com/vi/fyVBYA0CKr0/hqdefault.jpg"
  },
  {
    id: 3,
    title: "Improve Your English Story",
    content: "https://www.youtube.com/embed/QKd_8djmUqg",
    type: "video",
    category: "Speech Therapy",
    duration: "19 min",
    thumbnail: "https://img.youtube.com/vi/QKd_8djmUqg/hqdefault.jpg"
  }
];
      ...
      <div className="flex-1 p-6">
        ...
        >
          ...
          <motion.div variants={itemVariants} className="mb-6">
            ...
            <p className="text-[#3B1E54]">Learn more about speech therapy exercises for children.</p>
          </motion.div>
              ...
              {filteredResources.map(res => (
                ...
                >
                  <div className="flex items-center justify-between mb-3">
                    ...
                    <span className="bg-[#9B7EBD] text-[#EEEEEE] text-xs px-2 py-1 rounded">{res.category}</span>
                  </div>
