...
// const Storytelling = () => {
//   const [step, setStep] = useState("intro"); // intro → story → feedback
...
//         style={{
//           backgroundImage:
//             "url('https://i.pinimg.com/736x/7c/60/29/7c6029edae91ec5def8099c11710fe16.jpg')",
//         }}
//       ></div>
...
//                   <p className="text-xl font-bold text-[#9B7EBD]">{feedback.clarity}</p>
//                 </div>
//               </div>
//             </div>
  ...
  return (
    <div className="relative min-h-screen overflow-hidden">
      ...
      <div className="relative z-20 flex flex-col items-center justify-center min-h-screen p-4">
        ...
        {step === "intro" && (
          <div className="text-center max-w-md bg-white p-8 rounded-2xl shadow-2xl border-4 border-[#9B7EBD]">
            <h1 className="text-4xl font-bold text-[#3B1E54] mb-4">Story Time!</h1>
            <div className="text-6xl mb-4">📚</div>
            <p className="text-[#3B1E54] mb-6 text-lg">
              Listen to stories and practice reading!
            </p>
        ...
        {step === "story" && (
          <div className="w-full max-w-2xl bg-white shadow-2xl rounded-2xl p-6 border-4 border-[#9B7EBD]">
            <div className="text-center mb-6">
              <div className="text-6xl mb-2">{story.image}</div>
              <h2 className="text-3xl font-bold text-[#3B1E54] mb-2">{story.title}</h2>
            </div>

            <div className="bg-[#EEEEEE] p-6 rounded-xl mb-6 border-2 border-[#D4BEE4]">
              <p className="text-[#3B1E54] text-2xl leading-relaxed text-center">{story.content}</p>
            </div>
        ...
        {step === "feedback" && (
          <div className="w-full max-w-2xl bg-white shadow-2xl rounded-2xl p-6 border-4 border-[#9B7EBD]">
            <div className="text-center mb-6">
              <div className="text-6xl mb-2">🎉</div>
              <h2 className="text-3xl font-bold text-[#3B1E54]">Great Job Reading!</h2>
            </div>

            <div className="bg-[#EEEEEE] p-6 rounded-xl mb-6 border-2 border-[#D4BEE4]">
              <div className="flex justify-center mb-4">{renderStars(feedback.score)}</div>
              <p className="text-2xl font-bold text-[#3B1E54] text-center mb-6">
                Score: {feedback.score} / 10
              </p>
              ...
              <div className="grid grid-cols-2 gap-4 mb-6">
                <div className="bg-[#D4BEE4] p-4 rounded-xl border border-[#9B7EBD]">
                  <p className="text-sm text-[#3B1E54] font-semibold">Pronunciation</p>
                  <p className="text-xl font-bold text-[#9B7EBD]">{feedback.pronunciation}</p>
                </div>
                <div className="bg-[#D4BEE4] p-4 rounded-xl border border-[#9B7EBD]">
                  <p className="text-sm text-[#3B1E54] font-semibold">Clarity</p>
                  <p className="text-xl font-bold text-[#9B7EBD]">{feedback.clarity}</p>
