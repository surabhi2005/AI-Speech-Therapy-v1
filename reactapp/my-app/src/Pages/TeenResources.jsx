...
// import { FaVideo, FaArrowRight, FaHeartbeat } from "react-icons/fa";
...
//     content: "https://www.youtube.com/embed/sj7KGWSi4k0",
//     type: "video",
//     category: "Speech Therapy",
//     duration: "24 min",
//     thumbnail: "https://img.youtube.com/vi/sj7KGWSi4k0/hqdefault.jpg"
//   },
//   {
//     id: 3,
//     title: "The Mona Lisa Mystery",
//     content: "https://www.youtube.com/embed/VuZLf5azatQ",
//     type: "video",
//     category: "Speech Therapy",
//     duration: "20 min",
//     thumbnail: "https://img.youtube.com/vi/VuZLf5azatQ/hqdefault.jpg"
//   }
// ];
...
// export default TeenResources;

import React, { useEffect, useState } from "react";
import { FaVideo, FaArrowRight } from "react-icons/fa";
import { motion } from "framer-motion";
import { useNavigate } from "react-router-dom";
import TeenSidebar from "./TeenSidebar"; // <-- Import TeenSidebar
...
const TeenResources = () => {
  ...
  if (loading) {
    return (
      <div className="flex min-h-screen bg-[#EEEEEE]">
        <TeenSidebar /> {/* Sidebar added here */}
        <div className="flex-1 flex flex-col items-center justify-center">
          <div className="animate-spin rounded-full h-12 w-12 border-t-4 border-[#3B1E54]"></div>
          <h4 className="mt-4 font-bold text-lg text-[#3B1E54]">Loading Resources...</h4>
          <p className="text-[#9B7EBD]">Gathering valuable information for you</p>
