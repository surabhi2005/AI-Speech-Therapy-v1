...
//   const progressData = [
//     { metric: "Pronunciation Accuracy", progress: 80 },
//     { metric: "Fluency Score", progress: 70 },
//     { metric: "Sessions Completed", progress: 90 },
//     { metric: "Confidence Level", progress: 75 },
//   ];
...
//           <FaChartLine className="mr-3 text-blue-600" /> Progress Overview
//         </h1>
...
import { 
  FaChartLine, FaCheckCircle, FaTimesCircle, FaRobot, FaMapMarkerAlt 
} from "react-icons/fa";
import {
...
export default function Progress() {
  ...
  const practiceLocations = [
    { id: 1, x: 30, y: 40, name: "Home", sessions: 12 },
    { id: 2, x: 60, y: 70, name: "Work", sessions: 8 },
    { id: 3, x: 20, y: 80, name: "Coffee Shop", sessions: 5 },
    { id: 4, x: 80, y: 30, name: "Library", sessions: 3 }
  ];

  const overallScore = Math.round(progressData.reduce((sum, item) => sum + item.progress, 0) / progressData.length);

  return (
    <div className="min-h-screen p-6 bg-[#EEEEEE]">
          ...
          <div className="bg-[#EEEEEE]/70 p-4 rounded-2xl shadow-md border border-[#9B7EBD]/30 md:col-span-2">
            ...
            <div className="flex justify-center gap-4 mt-2">
              <div className="flex items-center">
                <div className="w-3 h-3 bg-[#3B1E54] rounded-full mr-1"></div>
                <span className="text-xs text-[#3B1E54]">Pronunciation</span>
              </div>
              <div className="flex items-center">
                <div className="w-3 h-3 bg-[#9B7EBD] rounded-full mr-1"></div>
                <span className="text-xs text-[#3B1E54]">Fluency</span>
              </div>
              <div className="flex items-center">
                <div className="w-3 h-3 rounded-full mr-1" style={{ backgroundColor: "#7D9D9C" }}></div>
                <span className="text-xs text-[#3B1E54]">Confidence</span>
              </div>
            </div>
          </div>
        </div>
